 ...
 * Created by Administrator on 2018/8/13.
 */
public class DragRefreshRecylerView extends RecyclerView {
    /**
     * item 类型
     */
    ...
    public DragRefreshRecylerView(Context context) {
        super(context);
        init();
    }

    public DragRefreshRecylerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public DragRefreshRecylerView(Context context, AttributeSet attrs, int defStyle) {
