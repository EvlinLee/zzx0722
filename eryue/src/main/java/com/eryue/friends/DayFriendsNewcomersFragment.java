...
public class DayFriendsNewcomersFragment extends BaseFragment implements DayFriendPresenter.IFriendsListener,DragRefreshListView.DragRefreshListViewListener,DayFriendPresenter.IFriendsExListener {
    ...
    private void initView(){
        ...
        adapter = new DayFriendsAdapter(getContext(),"Newcomers");
