...
public class HomeViewPagerAdapter<T> extends BaseViewPagerAdapter {
    ...
    public HomeViewPagerAdapter(Context context, List<String> data) {
        super(context,data);
        this.context = context;
    }
...
//            ImageLoader.getInstance().displayImage(((String) object),var1,optionsSmall);
            Glide.with(context).load((String) object).placeholder(R.drawable.img_default_contract).into(imgView);
