...
public class PermissionsManager {
    ...
    private synchronized void removePendingAction(@Nullable PermissionsResultAction action) {
        for (Iterator<PermissionsResultAction> iterator = mPendingActions.iterator();
             iterator.hasNext(); ) {
            PermissionsResultAction action1 = iterator.next();
            if (action1 == action || action1 == null) {
                iterator.remove();
            }
        }
    }
     ...
     */
    @SuppressWarnings("unused")
    public synchronized void requestPermissionsIfNecessaryForResult(@Nullable Object object,
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            ...
            if (permList.isEmpty()) {
                ...
                executePermissionsRequest(object, permsToRequest, 1);
            }
        }
    }
    ...
    private List<String> getPermissionsListToRequest(@NonNull Activity activity,
        ...
        for (String perm : permissions) {
            ...
            } else if (!PermissionUtil.selfPermissionGranted(activity, perm)) {
    ...
    /**
     * Calls {@link #checkDeniedPermissionsNeverAskAgain(Object, String, String, String, DialogInterface.OnClickListener, String[], StartActivityForResultAction)}
    ...
    public static boolean checkDeniedPermissionsNeverAskAgain(final Object object,
        ...
        return checkDeniedPermissionsNeverAskAgain(object, rationale,
                positiveButton, negativeButton, null, deniedPerms,startActivityForResultAction);
    }
    ...
    public static boolean checkDeniedPermissionsNeverAskAgain(final Object object,
                                                              ...
                                                              String[] deniedPerms,
                                                              final StartActivityForResultAction startActivityForResultAction) {
                ...
                AlertDialog dialog = new AlertDialog.Builder(activity)
                        ...
                        .setPositiveButton(positiveButton, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                intent.setData(uri);
                                StartActivityManager.getInstance().startActivityForResult(object, intent, startActivityForResultAction);
                            }
                        })
